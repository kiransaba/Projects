...
from setting_constant import WAIT_TIME_MEDIUM, WAIT_TIME_SHORT , click_element, wait_for_element

def navigate_to_footer_screen(self):
    try:
        logging.info("Navigating to the Footer screen...")
...
def footer_name(wait, variable_name):
    try:
        enter_name = wait_for_element(wait, (By.ID, "//input[@value='New Footer']"))
