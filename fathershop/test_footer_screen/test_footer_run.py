...
from theme_constants import check_cache_btn,no_element_dropdown,create_new_btn,duplicate,delete,filter_search,edit,color,gradient,camera,save,click_back_btn,edit_color,\
edit_gradient,image_options
...
class Footer:
    ...
    def edit_column(self):
        try:
         edit_column(self.wait)
         self.results["Edit column screen is opened"] = "Passed"
        except Exception as e:
         self.results["Edit column screen is not opened"] = f"Failed: {e}"
    ...
    def write_to_excel(self, folder_name="excel_results", file_name="footer_result.xlsx"):
...
#————————————————————————————————————————————————————————————
    def test_footer_functions(self, setup):
        ...
        # footer.add_column_btn() # can run ths command it is optional
