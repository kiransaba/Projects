...
class Add_Return_Status:
 ...
 def write_to_excel(self, folder_name="excel_results", file_name="add_return_status_result.xlsx"):
...
class TestSettingPage:
    ...
    def test_user_functions(self, setup):
        ...
        #add_status.login()                      #Commented part will be used in the near future
        ...
        add_status.write_to_excel()
        add_status.enter_return_status_name("odercomplete12")
        add_status.write_to_excel()
        add_status.enter_return_status_name1("odercomplete12")
        add_status.write_to_excel()
