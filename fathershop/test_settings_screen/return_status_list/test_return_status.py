...
from return_status_helper import click_return_statuses_tab,click_checkbox_btn,click_edit_btn,click_tab_back
class Return_Statuses_Page:
 ...
 def write_to_excel(self, folder_name="excel_results", file_name="return_status_result.xlsx"):
...
class TestSettingPage:
    ...
    def test_user_functions(self, setup):
        driver = setup
        return_status= Return_Statuses_Page(driver)
        #return_status.login()                            #Comemented Part is required in Future
        #return_status.write_to_excel()
        #return_status.navigate_to_settings()
        #return_status.write_to_excel()
        return_status.click_watch_btn()
        return_status.write_to_excel()
        return_status.click_close_btn()
        return_status.write_to_excel()
        return_status.click_return_statuses_tab()
        return_status.write_to_excel()
        return_status.click_addnew_btn()
        return_status.write_to_excel()
        return_status.click_tab_back()
        return_status.write_to_excel()
        return_status.click_addnew_btn()
        return_status.write_to_excel()
        return_status.click_cancel_btn()
        return_status.write_to_excel()
        return_status.click_edit_btn()
        return_status.write_to_excel()
        return_status.click_tab_back()
        return_status.write_to_excel()
        return_status.click_edit_btn()
        ...
        return_status.click_cancel_btn()
        return_status.write_to_excel()
        return_status.click_checkbox_btn()
        return_status.write_to_excel()
        return_status.click_delete_btn()
        return_status.write_to_excel()
