...
def click_weight_classes_tab(wait):
    try:
        tab = wait_for_element(wait, (By.XPATH, "(//div[@class='ant-card-body'])[21]"))
        tab.click()
        sleep(WAIT_TIME_SHORT)
        print("Weight_classes Tab is clicked successfully")
    except Exception as e:
        print(f"An error occurred on clicking Weight_classes Tab : {e}")
        traceback.print_exc()
        raise
...
def click_tab_back(wait):
    try:
        ...
        click_tab.click()
        sleep(WAIT_TIME_SHORT)
        print("Weight_classes back button is clicked ")
    except Exception as e:
        print(f"An error occurred on clicking Weight_classes back button: {e}")
        traceback.print_exc()
        raise
...
def click_checkbox_btn(wait):
    try:
        ...
        raise
#######################  ADD_Methods
def enter_weight_name(wait, value):
    try:
        ...
        sleep(WAIT_TIME_SHORT)
        print("Weight  Title is added")
    except Exception as e:
        print(f"Error in entering the Weight  Title in the textfield: {e}")
        traceback.print_exc()
        raise
def enter_weight_arabic_name(wait, value):
    try:
        ...
        add_name.send_keys(value)
        sleep(WAIT_TIME_SHORT)
        print("Weight Title is added in the Arabic")
    except Exception as e:
        print(f"Error in entering the Arabic Weight  Title in the textfield: {e}")
        traceback.print_exc()
        raise
def enter_weight_unit(wait, value):
    try:
        add_unit = wait_for_element(wait,((By.XPATH, "(//input[@class='w-full'])[3]")))
        add_unit.clear()
        add_unit.send_keys(value)
        sleep(WAIT_TIME_SHORT)
        print("Weight  Unit is added")
    except Exception as e:
        print(f"Error in entering the Weight  Unit in the textfield: {e}")
        traceback.print_exc()
        raise
def enter_weight_unit_arabic(wait, value):
    try:
        add_unit = wait_for_element(wait,((By.XPATH, "(//input[@class='w-full'])[4]")))
        add_unit.clear()
        add_unit.send_keys(value)
        sleep(WAIT_TIME_SHORT)
        print("Weight Unit is added in the arabic field")
    except Exception as e:
        print(f"Error in entering the Weight  Unit in the arabic textfield: {e}")
        traceback.print_exc()
        raise
...
def click_edit_btn(wait):
    try:
        click_edit = wait_for_element(wait, (By.XPATH, "(//span[@aria-label='edit'])[2]"))
        click_edit.click()
...
def edit_weight_name(wait, value):
    try:
        ...
        sleep(WAIT_TIME_SHORT)
        print("Weight  Title is edited")
    except Exception as e:
        print(f"Error in editing the Weight  Title in the textfield: {e}")
        traceback.print_exc()
        raise

def edit_weight_arabic_name(wait, value):
    try:
        add_name = wait_for_element(wait,((By.XPATH, "(//input[@class='w-full'])[2]")))
        sleep(WAIT_TIME_SHORT)
        add_name.clear()
        ...
        add_name.send_keys(value)
        sleep(WAIT_TIME_SHORT)
        print("Weight  Title is edited in the Arabic")
    except Exception as e:
        print(f"Error in editing the Arabic Weight  Title in the textfield: {e}")
        traceback.print_exc()
        raise
def edit_weight_unit(wait, value):
    try:
        ...
        sleep(WAIT_TIME_SHORT)
        print("Weight  Unit is edited")
    except Exception as e:
        print(f"Error in editing the Weight  Unit in the textfield: {e}")
        traceback.print_exc()
        raise
def edit_weight_unit_arabic(wait, value):
    try:
        ...
        edit_unit.send_keys(value)
        sleep(WAIT_TIME_SHORT)
        print("Weight  Unit is edited in the arabic field")
    except Exception as e:
        print(f"Error in editing the Weight  Unit in the arabic textfield: {e}")
        traceback.print_exc()
        raise
