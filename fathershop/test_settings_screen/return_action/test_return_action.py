...
from setting_constant import Base_URL,USERNAME,PASSWORD,LOGIN_URL,login,click_guide_btn,click_close_btn,navigate_to_settings,\
    click_save_btn,write_to_excel, Driver_path, click_watch_btn, click_delete_btn, click_cancel_btn,click_addnew_btn
from return_action_helper import click_return_action_tab,click_checkbox_btn,click_tab_back,click_edit_btn
class Return_Action_Page:
    ...
    def write_to_excel(self, folder_name="excel_results", file_name="return_action_result.xlsx"):
...
class TestSettingPage:
    ...
    def test_user_functions(self, setup):
        driver = setup
        return_action = Return_Action_Page(driver)
        # return_status.login()                                    #commented part is required in near future
        # return_status.write_to_excel()
        # return_status.navigate_to_settings()
        # return_status.write_to_excel()
        return_action.click_watch_btn()
        return_action.write_to_excel()
        return_action.click_close_btn()
        return_action.write_to_excel()
        return_action.click_return_action_tab()
        return_action.write_to_excel()
        return_action.click_addnew_btn()
        return_action.write_to_excel()
        return_action.click_tab_back()
        return_action.write_to_excel()
        return_action.click_addnew_btn()
        return_action.write_to_excel()
        return_action.click_cancel_btn()
        return_action.write_to_excel()
        return_action.click_edit_btn()
        return_action.write_to_excel()
        return_action.click_tab_back()
        return_action.write_to_excel()
        return_action.click_edit_btn()
        ...
        return_action.click_cancel_btn()
        return_action.write_to_excel()
        return_action.click_checkbox_btn()
        return_action.write_to_excel()
        #return_action.click_delete_btn()       #If you want to test delete functionality then un-comment it
        #return_action.write_to_excel()
