...
##Clicking Setting button
 ...
 def write_to_excel(self, folder_name="excel_results", file_name="add_return_reason_result.xlsx"):
...
class TestSettingPage:
    ...
    def test_user_functions(self, setup):
        ...
        add_reason.write_to_excel()
        add_reason.enter_return_reason_name("address is missing")
        add_reason.write_to_excel()
        add_reason.enter_return_reason_name1("address is missing")
        add_reason.write_to_excel()
