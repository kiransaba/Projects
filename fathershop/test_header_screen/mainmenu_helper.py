...
def create_newstyle_btn(wait):
    try:
        # Relative XPath to locate the "Create New Style" button
        new_style_btn_xpath = "//div[@data-name='general.menu']//div[@class='field-option']//a[@class='ui-create']"

        new_style_btn = wait_for_element(wait, (By.XPATH, new_style_btn_xpath))
        new_style_btn.click()
        sleep(WAIT_TIME_SHORT)
        print("Create New Style button is clicked successfully")
    except Exception as e:
