...
from theme_constants import check_cache_btn,no_element_dropdown,create_new_btn,duplicate,delete,filter_search,gradient,camera,save
...
class MainMenu:
    ...
    def write_to_excel(self, folder_name="excel_results", file_name="mainmenu_screen_result.xlsx"):
